...
extern int
motor_controller_get_position(motor_controller_t *, int32_t *position_ptr);

extern int
motor_controller_get_velocity(motor_controller_t *, float *velocity_ptr);

extern int
motor_controller_set_velocity(motor_controller_t *, float speed);

extern int
motor_controller_set_position_feedforward(motor_controller_t *, int16_t ff);

extern int
motor_controller_set_position_gain(motor_controller_t *, int16_t gain);
